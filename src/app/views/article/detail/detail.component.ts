...
import {Subject, takeUntil} from 'rxjs'; // Импортируем Subject и takeUntil
...
export class DetailComponent implements OnInit, OnDestroy {
  ...
  // Добавляем Subject для управления отписками
  ...
  // Добавляем ngOnDestroy для очистки подписок
  ngOnDestroy(): void {
    this.destroy$.next();
